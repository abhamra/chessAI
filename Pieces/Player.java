...
public class Player {
  ...
  public Player(boolean white)
  {
    ...
    if(white) {
      ...
      pieces.add((king = new King(7, 4, true)));
      ...
      pieces.add((king = new King(0, 3, true)));
      pieces.add(new Queen(0, 4, true));

      pieces.add(new Bishop(0, 2, true));
      pieces.add(new Bishop(0, 5, true));

      pieces.add(new Knight(0, 1, true));
      pieces.add(new Knight(0, 6, true));
